...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Get in touch with Design By Dial to discuss your vacation rental direct booking website. Book a free consultation or send us a message.",
  path: "/contact",
});
    ...
    <>
      ...
      <Section className="pt-4! md:pt-4!">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <Reveal delay={150}>
            <h2 className="font-display text-xl font-semibold">Or Book a Time Directly</h2>
